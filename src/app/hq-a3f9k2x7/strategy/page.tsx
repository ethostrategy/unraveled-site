...
const VERTICALS: Vertical[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      { label: "Who Real Talk is for", body: "Real Talk goes deep, so it's built for peers on equal footing: friends, romantic partners, siblings, and student peers. Not steep power gaps (a parent and a young child, a boss and a report), where the \"no ammo\" promise is harder to trust. Sweet Talk, light and group-friendly, is the one for mixed ages and bigger gatherings." },
