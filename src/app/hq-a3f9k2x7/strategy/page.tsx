...
const VERTICALS: Vertical[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      { label: "How it plays", body: "Goal is to get closer, not to win. Built for two people in an existing relationship, not an icebreaker. The skip: with both decks open, a player can dodge one card by drawing from the other deck instead (Real Talk to Sweet Talk, or the reverse), but you get only one skip and must follow through on the swapped card. Several rules still open (climb the tiers vs free-pick, dare pile)." },
