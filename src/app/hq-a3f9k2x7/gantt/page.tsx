...
const OVERVIEW: { name: string; color: string; work: [number, number]; ms: { t: string; q: number; cont?: boolean; detail?: boolean; desc?: string }[] }[] = [
  ...
  { name: "B2C Products", color: "#c768c6", work: [2, 14], ms: [
    ...
    { t: "Escape rooms", q: 11.9, desc: "The Unraveling: a Glow-&-Go-style gamified escape-room experience (late 2028), designed by the Experiential Design Lead (~4 months after they start)." },
  ...
  { name: "B2B Products", color: "#f0a0b8", work: [2, 15], ms: [
    { t: "Corporate workshops", q: 9.5, desc: "First paid B2B: relationship/culture workshops for companies, once grassroots cool is established. Repackages the adult framework, so founders can run the first ones (no net-new curriculum)." },
    { t: "University", q: 11, desc: "University pilots + partnerships, the easiest institutional entry via the MBA + advisory network. Students are near the core 18-30 audience, so content is lightly adapted, not net-new." },
