...
const OVERVIEW: { name: string; color: string; work: [number, number]; yearOnly?: boolean; ms: { t: string; q: number; cont?: boolean; detail?: boolean; desc?: string; gated?: boolean }[] }[] = [
  ...
  { name: "B2C Products", color: "#c768c6", work: [2, 14], ms: [
    ...
    { t: "Between Us launch", q: 3.71, desc: "Between Us launches on Dec 5, the Unraveled founding day, with all three decks: Real Talk (intense), Sweet Talk (light variety pack), and Self Talk (solo). The first physical product to market and the first consumer revenue, ahead of the app." },
    { t: "Spicy deck (V-Day)", q: 4.2, detail: true, gated: true, desc: "A spicy / adult edition (working title Dirty Talk / Sexy Talk), the sultry sibling to Sweet Talk. Dual-mode (two-player and group). Target ~Feb 2027 for Valentine's Day, an aggressive fast follow to the Dec 5 launch, so it may slip. Idea stage." },
