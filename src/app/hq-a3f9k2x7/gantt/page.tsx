...
const OVERVIEW: { name: string; color: string; work: [number, number]; ms: { t: string; q: number; cont?: boolean; detail?: boolean; desc?: string }[] }[] = [
  ...
  { name: "Operations", color: "#b884d8", work: [0, 12], ms: [
    { t: "FF1 applied", q: 0.3, detail: true, desc: "Future Founders Phase 1 application (due Jan 2026)." }, { t: "FF1", q: 1.85, detail: true, desc: "Future Founders Phase 1 — accelerator demo day (June 2026)." }, { t: "LLC registered", q: 2.05 }, { t: "Advisory board", q: 7, desc: "Stand up the formal strategic advisory board after the MBA — better network + clearer cap table. Advisory equity offered then; kept off the table until now to avoid early dilution." },{ t: "Summer intern", q: 2.6, detail: true }, { t: "FF2", q: 3.7, detail: true, desc: "Future Founders Phase 2." }, { t: "CEO full-time", q: 6.2, desc: "Madhuri goes full-time as CEO (Aug 2027), alongside the MBA." }, { t: "Trademark registered", q: 7.5 }, { t: "AI engineer", q: 8.2, desc: "Founding AI Engineer, first hire (~28 Q1) — builds App v2's intelligence layer and owns data security/privacy compliance." }, { t: "Experiential marketing", q: 9.6, desc: "Experiential Marketing Lead — owns galas, live experiences, and growth channels as they scale (~mid-2028)." }, { t: "Experiential design", q: 10.8, desc: "Experiential Design Lead — designs the gamified experiences + curriculum, hired ahead of the 2029 B2B/school push." },
  ] },
