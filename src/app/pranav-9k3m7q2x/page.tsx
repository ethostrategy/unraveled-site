...
const WEEKS: Week[] = [
  { n: 1, dates: "Jun 29 – Jul 5", theme: "Get Grounded", focus: ["Set up your pranav@unraveleduniverse.com email and explore Google Workspace", "Read the Workplace Rights PDF", "Bookmark the Unraveled roadmap PDF", "RSVP to every weekly intern check-in, and reach out to reschedule any you cannot make", "Set up your Airtable account and open the assessments base (the 2020 Draft and the four assessment tabs)", "Review the 2020 assessment drafts"], deliverable: "Review and refine the outdated assessment drafts. Standardize every item to a 1-5 Likert statement, keep the dual-perspective structure, and aim for about 5 items per block across all four relationship types. Give each item two versions: a formal one (academically publishable and clinically testable) and a plain, accessible user-facing one. The formal version carries the rigor; the user-facing one carries the accessibility. Capture each item and its rationale in Airtable. Due by Jul 6." },
