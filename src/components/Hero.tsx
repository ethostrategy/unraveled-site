  ...
  return (
    ...
    >
      <div className="relative mx-auto max-w-7xl">
        <Reveal>
          <h1
            className="text-balance text-[2.1rem] leading-[1.06] text-white sm:text-[2.6rem] lg:text-[3.3rem] xl:text-[4rem] 2xl:text-[4.6rem]"
        ...
        <Reveal delay={120}>
          <p className="mx-auto mt-6 max-w-2xl text-balance text-lg leading-relaxed text-white/85 lg:text-xl">
